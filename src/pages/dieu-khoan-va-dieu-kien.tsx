        ...
        <div className='container'>
          <div className='grid grid-cols-12 @992:gap-10 gap-6'>
            ...
            <div className='@992:col-span-9 @992:order-2 order-1 col-span-12 space-y-5'>
              ...
              <p className='@992:fs-16 fs-14'>Điều Kiện Về Giao Dịch Chung Tại Công ty TNHH AGRIAMAZING</p>
              <p className='@992:fs-16 fs-14'>
                Chào mừng quý khách đến với hệ thống cửa hàng dành cho người trung niên và cao tuổi AGRIAMAZING.
              </p>
              <p className='@992:fs-16 fs-14'>
                Công ty TNHH AGRIAMAZING có trụ sở chính tại TP. Hồ Chí Minh và các chi nhánh trên toàn quốc. Website{' '}
                ...
                để tham khảo hoặc mua sắm, quý khách đã đồng ý tuân thủ và ràng buộc với những quy định của AGRIAMAZING.
                Vui lòng xem kỹ các quy định và hợp tác với AGRIAMAZING để xây dựng một hệ thống cửa hàng ngày càng thân
                thiện và phục vụ tốt những yêu cầu của khách hàng trung niên và cao tuổi. Ngoài ra, nếu quý khách có bất
                cứ câu hỏi nào về những thỏa thuận trên đây, vui lòng liên hệ với AGRIAMAZING qua địa chỉ email{' '}
                <OBYLink
                ...
                . Quý khách vui lòng kiểm tra thường xuyên để cập nhật những thay đổi của AGRIAMAZING.
              </p>
              ...
              <p className='@992:fs-16 fs-14'>
                ...
                Bà Yêu. Nếu AGRIAMAZING phát hiện bất kỳ thông tin nghi ngờ giả mạo nào, AGRIAMAZING sẽ khóa tài khoản
              ...
              <ul className='list-disc pl-5 spacy-y-2 @992:fs-16 fs-14'>
                <li>
                  AGRIAMAZING cam kết cung cấp thông tin và dịch vụ trên website{' '}
                  <OBYLink href='/' title='AGRIAMAZING' className='text-oby-primary @992:fs-16 fs-14'>
                    https://ongbayeu.com/
                  </OBYLink>{' '}
                ...
                <li>
                  ...
                  , trách nhiệm của AGRIAMAZING sẽ không vượt quá giá trị đơn hàng mà quý khách đã đặt. Quý khách cũng
                  nên lưý rằng, AGRIAMAZING không chịu trách nhiệm đối với các thiệt hại phát sinh từ việc sử dụng sản
                ...
                <li>
                  AGRIAMAZING không chịu trách nhiệm đối với bất kỳ nội dung, bình luận hoặc thông tin nào được đăng tải
                  trên website{' '}
                  <OBYLink href='/' title='AGRIAMAZING' className='text-oby-primary @992:fs-16 fs-14'>
                    https://ongbayeu.com/
                  </OBYLink>{' '}
              ...
              <ul className='list-disc pl-5 spacy-y-2 @992:fs-16 fs-14'>
                <li>
                  AGRIAMAZING có quyền thay đổi hoặc cập nhật Điều khoản và Điều kiện sử dụng này bất cứ lúc nào mà
                  không cần thông báo trước cho quý khách. Việc sử dụng tiếp tục của quý khách sau khi có bất kỳ thay
                  đổi nào đối với Điều khoản và Điều kiện này sẽđược coi là chấp nhận những thay đổi đó.
                </li>
                <li>
                  AGRIAMAZING có quyền chấm dứt hợp đồng với quý khách nếu quý khách vi phạm bất kỳ điều khoản nào của
                  Điều khoản và Điều kiện này hoặc vi phạm pháp luật hiện hành mà không cần thông báo trước.
                </li>
                <li>
                  Trong trường hợp hợp đồng giữa quý khách và AGRIAMAZING bị chấm dứt, tất cả các quyền và nghĩa vụ của
                  quý khách và AGRIAMAZING sẽ ngừng tồn tại, trừ những quyền và nghĩa vụ mà theo tính chất của chúng vẫn
              ...
              <ul className='list-disc pl-5 spacy-y-2 @992:fs-16 fs-14'>
                ...
                <li>
                  Trong trường hợp có tranh chấp phát sinh giữa quý khách và AGRIAMAZING liên quan đến việc sử dụng
                  website{' '}
                  <OBYLink href='/' title='AGRIAMAZING' className='text-oby-primary @992:fs-16 fs-14'>
                    https://ongbayeu.com/
                  </OBYLink>
