...
const ToTopButton: React.FunctionComponent<OBYButtonProps> = (props) => {
  ...
  return (
    <OBYButton
      ...
      className={cn(
        'text-oby-primary border border-oby-primary bg-white !rounded-full w-12 h-12 opacity-0 pointer-events-none transition-opacity fixed z-10 bottom-[150px] right-8',
