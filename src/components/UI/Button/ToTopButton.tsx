...
const ToTopButton: React.FunctionComponent<OBYButtonProps> = (props) => {
  ...
  return (
    <OBYButton
      ...
      className={cn(
        'text-oby-primary border border-oby-primary bg-white !rounded-full w-12 h-12 opacity-0 pointer-events-none transition-opacity fixed z-10 @992:bottom-[150px] bottom-[210px] right-8',
