...
export const CategoryButton: React.FunctionComponent = () => {
  return (
    <div className='w-[173px] h-[44px] flex justify-between items-center bg-gradient-to-r from-agr-orange via-agr-mid-orange to-agr-light-orange px-4 py-3 rounded-lg'>
