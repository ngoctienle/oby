  ...
  return (
    <>
      {initializeCategory
        ...
        .map((item) => (
          <div
            className='flex flex-row justify-between items-center cursor-pointer rounded-2 p-4'
            key={item.id}
          ...
          >
            <div className='flex flex-row items-center  gap-2'>
              ...
              <OBYLink
                ...
                className='text-[#454545] whitespace-nowrap fs-16 font-bold truncate max-w-[160px]'
              >
                {item.name}
              </OBYLink>
            </div>
